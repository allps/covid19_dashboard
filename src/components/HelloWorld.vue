<template>
  <div>
    ...
    <section class="content">
        ...
        <div class="container">
          <h1 class="title is-3" style="margin-bottom: 0.1rem!important;">
              Novel Corona Virus (COVID19)
          </h1>

            <div class="control has-icons-left countryDropdown" >
                <div class="select">
                    <select style="color: #042554">
      ...
      <section class="hero is-medium" style="background-color: #042554">
          <div class="hero-body">
              <div class="container">
                  ...
                  <img src="../assets/facebook.png" style="margin-right: 2rem">
                  <img src="../assets/instagram.png" style="margin-right: 2rem">
                  <img src="../assets/twitter.png" style="margin-right: 2rem">
                  <img src="../assets/linkedin.png" style="margin-right: 2rem">
